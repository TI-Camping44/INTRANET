...
-- ACTUALIZACION sobre una base ya instalada
-- =====================================================================
--
-- Generado por scripts/generar-actualizacion.sh. No editar a mano.
--
-- Aplicar en el editor SQL de Supabase, de una sola vez, sobre una
-- base que ya tenga la instalacion original.
--
-- Es idempotente: si se corre dos veces, la segunda no rompe nada
-- ni duplica registros.
--
-- Incluye:
--   · Las migraciones posteriores a la instalacion original
--   · Los datos reales del SGC (mapa de procesos, perfiles de
--     puesto, juego documental) y el retiro de lo inventado
-- =====================================================================
